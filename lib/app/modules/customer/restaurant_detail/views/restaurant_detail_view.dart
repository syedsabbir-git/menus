...
class RestaurantDetailView extends GetView<RestaurantDetailController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text(controller.restaurant.name)),
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      _CartControls(item: item, controller: controller),
                    ],
                  ),
                ),
              );
      ...
      bottomNavigationBar: GetBuilder<RestaurantDetailController>(
        builder: (_) {
...
class _CartControls extends StatelessWidget {
  const _CartControls({required this.item, required this.controller});
